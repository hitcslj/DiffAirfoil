...
from utils import Fit_airfoil,vis_airfoil2,de_norm,calculate_smoothness,cal_diversity_score
import os
...
def create_argparser():
    ...
    defaults = dict(
        ...
        run_name=run_name,
        start_iter=1,
        model_checkpoint="/home/bingxing2/ailab/scxlab0058/airfoil/DiffAirfoil-main/weights/dit_y_new/model-airfoil-150000.pth",
        optim_checkpoint="/home/bingxing2/ailab/scxlab0058/airfoil/DiffAirfoil-main/weights/dit_y_new/optim-airfoil-150000.pth",
        schedule_low=1e-4,
        schedule_high=0.02,
        device=device,
    )
